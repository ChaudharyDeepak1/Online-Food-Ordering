...
?>
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <a href="">Checkout</a>
                                <!-- checkout.php?res_id=<?php echo $_GET['res_id'];?>&action=check" class="btn btn-danger btn-lg disabled -->
                                ...
                                <?php
                                        ...
                                        ?>
                                <a href="">Checkout</a>
                                <!-- checkout.php?res_id=<?php echo $_GET['res_id'];?>&action=check" class="btn btn-success btn-lg active -->
                                <?php   
                                        }
                                        ?>
